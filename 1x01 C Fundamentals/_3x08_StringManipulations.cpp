...
static void A() {
	...
	printf("\n");
	printf("'strlen' returns a value of size_t (an unsigned int)\n");
	printf("\n");
	//int length2 = (signed)strlen(String1);
	printf("Is it better to use: \n");
	printf("    size_t length1 =         strlen(String1);\n");
	printf("or  int    length1 = (signed)strlen(String1);\n");
	// No straightforward way to find the answer.
	printf("\n");
	printf("==============================================================================\n");
	system("pause");
...
static void E() {
	...
	printf("==============================================================================\n");
	printf("\n");
	printf("Note: strlwr() and strup() are not part of standard C library.\n");
	printf("\n");
...
static void G() {
	...
	printf("\n");
	printf("  strspn returned %u to NumFound.\n", NumFound);
	printf("\n");
